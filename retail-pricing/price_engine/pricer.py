def increase_price_by_percentage_on_class(initial_price_list, percentage: float, class_param: str):
    ...
    new_price_list.loc[(res['Class'] == class_param), 'SellingPrice'] = new_price_list['SellingPrice'] * (1+percentage/100)
...
def optimize_price_index(initial_price_list):
    ...
    """
    new_price_list = initial_price_list.copy()
    new_price_list.loc[(res['Class'] == 'Complementary'), 'SellingPrice'] = new_price_list['SellingPrice'] * 1.125
    new_price_list.loc[(res['Class'] == 'Driver'), 'SellingPrice'] = new_price_list['SellingPrice'] * 0.96
    new_price_list.loc[(res['Class'] == 'Independent'), 'SellingPrice'] = new_price_list['SellingPrice'] * 0.98
    return new_price_list[["ProductId","SellingPrice"]]