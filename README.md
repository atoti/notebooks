...
|                              <sub>[Price Elasticity of Demand](./notebooks/price-elasticity/main.ipynb)</sub>                        |          <sub>insurance</sub>           |                          <sub>price elasticity</sub>                   | <sub>what if, scenaio simulations</sub>|                 <sub>XGBoost</sub>                |
