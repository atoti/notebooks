...
NON_ATOTI_NOTEBOOKS = [
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "0-prepare-the-datasets.ipynb",
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "1-roll-the-datasets.ipynb",
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "2-extract-the-features-test.ipynb",
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "2-extract-the-features-train.ipynb",
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "2-extract-the-features-val.ipynb",
    NOTEBOOKS_DIRECTORY / "wildfire-prediction" / "notebooks" / "3-classification-with-OPLS.ipynb"
]
...
NOTEBOOKS_TO_SKIP = (
    DATA_PREPROCESSING_NOTEBOOKS + NOTEBOOKS_WITH_ERRORS + NOTEBOOKS_WTIH_ALT_DS + NON_ATOTI_NOTEBOOKS
)
